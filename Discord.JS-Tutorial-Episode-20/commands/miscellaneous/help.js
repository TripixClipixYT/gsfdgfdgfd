...
module.exports = {
    ...
    let arr = [];
    let types = ["Moderation", "Miscellaneous","Youtube","Discord Server"];
    ...
    if (!args[0]) {
        ...
        .setTimestamp()
        .setDescription(`These are the avaliable commands for the Youtube Bot!\nThe bot prefix is: **${prefix}**`)
        .addField("More commands coming soon...", "_**Stay Connected_**")
